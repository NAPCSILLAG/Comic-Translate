...
class BackgroundEstimator:
    ...
    def estimate(
        ...
        Args:
            image_f32: [H, W, 3] float32, 0..1 tartomány, RGB
            bbox:      [x1, y1, x2, y2]
            border_px: mintavételezési szegély szélessége

        Returns:
            [3] float32 RGB szín, 0..1 tartomány
        """
...
class InpaintingManager:
    ...
    def _process_bubble(
        ...
        # 3. Háttér becslés
        bg_color  = self._bg.estimate(image_f32, bbox)
