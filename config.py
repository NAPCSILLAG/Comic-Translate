...
class OCRConfig:
    ...
    det_model_path: str = "ocr/ppocr-v5-onnx/ch_PP-OCRv5_mobile_det.onnx"
...
class VisionConfig:
    """
    Unified vision konfiguráció – Qwen2-VL + Gemma4.
    ...
    gemma_model:    str   = "gemma4:e4b-it-q8_0"
    gemma_base_url: str   = ""    # üres = translation.base_url-t használja
...
class Config:
    ...
    def apply_env_overrides(self) -> None:
        ...
        Támogatott változók:
          ...
          COMIC_GEMMA_MODEL        – Gemma szemantikai modell neve
        ...
        # ── Vision / Gemma ─────────────────────────────────────────────────
        if v := _str("COMIC_GEMMA_MODEL"):
            self.vision.gemma_model = v
    ...
    def print_summary(self) -> None:
        ...
        lines += [
            ...
            f"  Gemma:  {self.vision.gemma_model}",
            f"  VLM:    {self.vision.vlm_model_id}",
            f"  OCR:    ppocr-v5-onnx (GPU={self.ocr.use_gpu})",
            f"  Inpaint: lama-manga-dynamic.onnx",
