...
class Qwen2VLProvider(BaseProvider):
    ...
    def __init__(
        ...
        # Config-driven: nincs hardcode HF modell ID
        # Override: COMIC_VLM_MODEL env var vagy cfg.vision.vlm_model_id
        self.model_id   = model_id or cfg.vision.vlm_model_id
        self._model     = None
        ...
        try:
            ...
            with torch.no_grad():
                gen_ids = self._model.generate(
                    **inputs,
                    max_new_tokens=cfg.vision.max_new_tokens,
                    do_sample=False,
                )
